...
const EditProduct = () => {
    ...
    const Doorerror = {
        title:"", price:"",hostingfee:"" ,condition:"",power:"",machines:"",producttype:""
    }
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`${serverUrl}/api/product/updateProduct/${productId}`, {
                title:addproduct.title, price:parseInt(addproduct.price),hostingfee:parseInt(addproduct.hostingfee),condition:addproduct.condition,power:addproduct.power,machines:addproduct.machines,producttype:addproduct.producttype
            });
